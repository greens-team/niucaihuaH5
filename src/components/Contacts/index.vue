  ...
  <div class="ContactsList flex flex-1 flex-col">
    ...
    <div class="flex-1 relative">
      <div class="absolute inset-0 overflow-y-auto" ref="listBox">
        <van-checkbox-group v-model="$store.state.contacts.selectedUserGids" class="bg-white checkBoxGroup">
          <van-checkbox
    ...
    >
      <div class="flex-1 ellipsis">
        ...
        <span class="text-base" v-for="(r,i) in $store.state.contacts.selectedUserGids" :key="i">
          <span v-if="i">,</span>
          {{r.split(',')[0]}}
        </span>
      </div>
