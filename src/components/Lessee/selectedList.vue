...
<template>
  <div class="selectedListLessee  flex flex-1 flex-col">
    <van-nav-bar title="联系人" left-text="返回" @click-left="$store.state.lessee.selectedUserGids = $store.state.lessee.confirmUserGids; $router.go(-1)"  @click-right="finish" left-arrow>
    ...
    <div class="flex-1 relative">
      <div class="absolute inset-0 overflow-y-auto">
        ...
        <!-- <div class="flex"> -->
          ...
          <van-checkbox-group v-model="$store.state.lessee.confirmUserGids" class="flex-1  ml-5"> 
            <van-checkbox v-for="(item, i) in $store.state.lessee.selectedUserGids" :key="i" icon-size="16px" 
