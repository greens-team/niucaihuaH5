      ...
      <div class="absolute inset-0 overflow-y-auto">
          ...
          <van-cell clickable>
            ...
            <template slot="default">
              <p class="p5">{{$store.state.task.addEditTaskParams.taskName}}</p>
            </template>
          </van-cell>
          ...
          <van-cell clickable>
            ...
            <template slot="default">
              <p class="p5">{{taskTypeOption[$store.state.task.addEditTaskParams.taskType-1] ? taskTypeOption[$store.state.task.addEditTaskParams.taskType-1].text : ''}}</p>
            </template>
          </van-cell>
          ...
          <van-cell clickable>
            ...
            <template slot="default">
              <p class="p5">{{$store.state.task.addEditTaskParams.taskTime ? $root.moment($store.state.task.addEditTaskParams.taskTime*1000).format('YYYY-MM-DD HH:mm') : '请选择时间'}}</p>
            </template>
          </van-cell>
          ...
          <van-cell clickable>
            ...
            <template slot="default">
              <p class="p5">{{alarmTimeText || '请选择提醒时间'}}</p>
            </template>
          </van-cell>
          ...
          <van-cell clickable v-if="$store.state.task.addEditTaskParams.taskType == 1">
            ...
            <template slot="default">
              <p class="p5">{{dealerName || '请选择相关经销商'}}</p>
            </template>
          </van-cell>
          ...
          <van-cell clickable>
            ...
            <template slot="default">
              <p class="p5">{{mainUserGidsFun(mainUserGids, 'refRlNm', 0)}}</p>
            </template>
          </van-cell>
          ...
          <van-cell clickable>
            ...
            <template slot="default">
              <p class="p5">{{mainUserGidsFun(otherUserGids, 'refRlNm', 1)}}</p>
            </template>
          </van-cell>
          ...
          <van-cell clickable v-if="$store.state.task.addEditTaskParams.taskType == 1">
            ...
            <template slot="default">
              <p class="p5">{{visitAimText || '请选择拜访目的'}}</p>
            </template>
          </van-cell>
          ...
          <van-cell clickable>
            ...
            <template slot="default">
              <p class="p5">{{$store.state.task.addEditTaskParams.comment}}</p>
            </template>
          </van-cell>
          ...
          <div v-if="$store.state.task.addEditTaskParams.address" class="bg-gray-100 pt-3 pb-2">
            ...
            <div v-if="$store.state.task.addEditTaskParams.dealerDes">
              ...
              <van-cell clickable>
                ...
                <template slot="default">
                  <p class="p5">{{$store.state.task.addEditTaskParams.dealerDes}}</p>
                </template>
              </van-cell>
              ...
              <van-cell clickable>
                ...
                <template slot="default">
                  <p class="p5">{{$store.state.task.addEditTaskParams.visitComment}}</p>
                </template>
              </van-cell>
