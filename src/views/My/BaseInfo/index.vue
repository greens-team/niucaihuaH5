  ...
  <div class="Base">
    ...
    <div class="flex items-center p-5">
      <img
        ...
        class="border shadow-md border-white w-20 h-20 rounded-full"
        alt
      />
      <div class="text-sm text-gray-700 ml-5">
        <span class="font-bold text-xl text-black">王成阔</span>
        <p class="pt-2" style="color:#80848D">广州城市经理</p>
        <p style="color:#80848D">工号：1004746</p>
      </div>
    </div>

    <div class="pt-2 bg-gray-100">
      <van-cell-group>
        <van-field value="王成阔" label="姓名" disabled />
        <van-field value="1004746" label="工号" disabled />
        <van-field value="重卡 BU-湘患鄂大区-武汉" label="部门" disabled />
        <van-field value="武汉城市经理" label="职位" disabled />
        <van-field value="wangchengguang@sadfad.com" label="邮箱" disabled />
      </van-cell-group>
    </div>
  </div>
</template>
...
<style scoped>
.Base .van-cell:not(:last-child)::after {
  right: 16px;
}
